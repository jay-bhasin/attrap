...
def __main__():
    ...
    if args.initial and os.path.isfile(args.initial):
        tau_peaks = np.load(args.initial)
        eligibility_params_adj['tau_peaks'] = tau_peaks
    ...
    results_adj = te_mp.simulateLearningAdjustment_TeMP(args.sims, args.iters, t_trial, cf_prob_fun, 
                                   ...
                                   eligibility_params_adj, history_samples = history_samples, 
    ...
    np.save(args.directory+'/tau_peaks.npy',results_adj['tau_peaks'])
    np.save(args.directory+'/tau_peak_history.npy', results_adj['temp_history'])
    np.save(args.directory+'/tau_peak_mean.npy', results_adj['temp_history_mean'])
